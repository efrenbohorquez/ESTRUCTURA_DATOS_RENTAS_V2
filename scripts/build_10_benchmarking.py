...
si la "forma del latido" es mas erratica en Choco, lo que justificaria
...
# Panel B: Estacionalidad normalizada (ECG)
ax2 = axes[0, 1]
...
if len(common_idx) > 0:
    ...
    informe.append(f'   Correlacion ECG estacional: r = {corr_ecg:.3f}')
...
informe.append('   g) Alerta Roja permanente para Choco: ECG erratico')
...
3. **Brecha Bogota-Choco**: El ratio de desigualdad supera 10:1 en la
   ...
   ($12,500 vs $667). El electrocardiograma fiscal del Choco es mas
